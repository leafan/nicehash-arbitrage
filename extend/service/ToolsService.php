...
class ToolsService
{
     ...
     * @return array
     */
    public static function httpPostForJson($url, array $data, $buildToJson = true)
    {
        return json_decode(NetTools::post($url, $buildToJson ? NetTools::arr2json($data) : $data), true);
    }
     ...
     * @return array
     */
    public static function httpGetForJson($url)
    {
        return json_decode(NetTools::get($url), true);
    }
